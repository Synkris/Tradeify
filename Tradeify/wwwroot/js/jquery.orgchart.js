      ...
      /*  this.startEdit = function(id){
        ...
        */
        ...
        this.newNode = function(parentId){
            ...
            self.addNode({ id: nextId, name: '', parent: parentId, Link: ''});
        }
    ...
    function Node(data){
        ...
        this.render = function(opts){
            ...
            if(childLength > 0){
                ...
                for (var i in self.children) {
                    pt++;
                    if (pt == 1) {
                        mainTable += "<td colspan='2'class='ctg'>" + self.children[i].render(opts) + "</td>";
                    }else { mainTable += "<td colspan='2'>" + self.children[i].render(opts) + "</td>";}
        ...
        this.formatNode = function (opts) {
            ...
            var nameString = '',
                descString = '',
                LinkString = '';
            var finalDiv = "<div class='node' node-id='" + this.data.id + "'>";
            ...
            if (typeof data.link != "") {
                LinkString = "<div class='btn btn-dark' style='height: 30px;'>" + self.data.link + '</div>';
                finalDiv += LinkString;
            }
