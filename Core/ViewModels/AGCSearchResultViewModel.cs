...
{
    public class AGCSearchResultViewModel
    {
		private readonly IGeneralConfiguration _generalConfiguration;

		public AGCSearchResultViewModel(IGeneralConfiguration generalConfiguration)
		{
			_generalConfiguration = generalConfiguration;
		}
		public IPagedList<AGCWalletHistoryViewModel> AGCWalletHistoryRecords { get; set; }
		...
		public AGCSearchResultViewModel()
		{
    ...
    public class AGCWalletHistoryViewModel
    {
